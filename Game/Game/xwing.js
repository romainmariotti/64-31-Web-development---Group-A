...
export const engineSoundXwing = new Audio("../Game/Sound/xwingEngine.mp3");
...
export const shootingSoundXwing = new Audio("../Game/Sound/Blaster.mp3");
shootingSoundXwing.loop = true; // Allow looping for continuous shooting
shootingSoundXwing.volume = 0.1; // Adjust the volume

shootingSoundXwing.onloadeddata = () => {
  console.log("Blaster sound loaded successfully!");
};
shootingSoundXwing.onerror = () => {
...
export function startShootingXwing() {
  ...
  shootingSoundXwing.currentTime = 0; // Reset sound to the beginning
  shootingSoundXwing
    .play()
...
export function stopShootingXwing() {
  ...
  if (!shootingSoundXwing.paused) {
    shootingSoundXwing.pause();
    shootingSoundXwing.currentTime = 0; // Reset sound to the beginning
  }
}
  ...
  xwingBullets.push(
    {
      x: noseX_right,
      y: noseY,
      width: xwingBulletConfig.width,
      height: xwingBulletConfig.height,
    },
    {
      x: noseX_left,
      y: noseY,
...
export function xwingActions() {
  ...
  if (
    (xwingKeys["ArrowRight"] || xwingKeys["d"]) &&
    xwing.x + xwing.width < canvas.width
  ) {
    xwing.x += 20;
  }
  ...
  if (
    (xwingKeys["ArrowDown"] || xwingKeys["s"]) &&
    xwing.y + xwing.height < canvas.height
  ) {
    xwing.y += 20;
  }
